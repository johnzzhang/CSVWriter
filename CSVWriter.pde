/* 
  Fixed version of csv writing using processing.
...
void setup()
{
  ...
  dataTable.addColumn("wind speed");
  dataTable.addColumn("wind direction");
...
void serialEvent(Serial myPort){
  ...
  if (val!= null) { //We have a reading! Record it.
    ...
    newRow.setFloat("wind speed", sensorVals[0]);
    newRow.setFloat("wind direction", sensorVals[1]);
    ...
    {
      fileName = str(year()) + str(month()) + str(day()) + ".csv"; //this filename is of the form year+month+day
